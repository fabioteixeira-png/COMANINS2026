...
// Replace the client SDK import with admin
code = code.replace(
  "import { initializeApp } from 'firebase/app';\nimport { getFirestore, collection, getDocs } from 'firebase/firestore';",
  "import { initializeApp, getApps } from 'firebase-admin/app';\nimport { getFirestore } from 'firebase-admin/firestore';"
);

// Replace firebaseApp initialization
code = code.replace(
...
const firestoreDb = getFirestore(firebaseAdminApp, firebaseConfig.firestoreDatabaseId);`
);

// Replace legacy login implementation
code = code.replace(
