...
import { Upload, FileSpreadsheet, Plus, Save, X, Camera, RefreshCw, Trash2, Search, Download } from 'lucide-react';
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        <div className="p-4 border-b border-slate-200 bg-slate-50 flex justify-between items-center">
          <div className="flex items-center text-sm font-semibold text-slate-700">
            Filtros por coluna abaixo <span className="ml-2 text-xs font-normal text-slate-500">({sortedRecords.length} registros exibidos)</span>
          </div>
        </div>
              ...
              {isLoading ? (
                ...
                sortedRecords.map(record => (
                  <tr key={record.id} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="px-4 py-3">{record.observacao || '-'}</td>
